...
exports._xttParams = exports._tiktokApiParams = exports._liveSearchParams = exports._userSearchParams = exports._userPostsParams = void 0;
...
const _userSearchParams = (keyword, page = 1, xbogus) => {
    let cursor = 0;
...
const _liveSearchParams = (keyword, page = 1) => {
    let cursor = 0;
    for (let i = 1; i < page; i++) {
        cursor += 12;
    }
